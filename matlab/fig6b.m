...
xy=[-2.5 2.5 -2.5 2.5];
xx=linspace(xy(1),xy(2),1000);  y0=xx;  y1=xx.^2; ym1=sqrt(xx(501:1000));
plot(xx(1:1000),y0(1:1000),'k:','LineWidth',2)

h(1)=plot(xx(1:1000),y1(1:1000),'k--','LineWidth',2)
h(2)=plot(xx(501:1000),ym1,'k','LineWidth',2)

plot(xx(501:1000),-ym1,'k','LineWidth',2)
set(gca,'LineWidth',2); 
axis(xy); axis manual;
...
% %assign labels for handles
 legend(h,'y=x^{2}','y=\pm\surd{x}',3);
% %export to eps (change path and file name accordingly)
 print('-depsc2',sprintf('C:\\Documents and Settings\\ajay\\Desktop\\BootCampFig_1203\\BC_2003\\matlab\\fig6b'));
