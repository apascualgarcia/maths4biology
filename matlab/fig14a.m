...
xx=linspace(-3,3,1000);  ym1=xx+xx.^3/6;  
...
legend(h,'sinh x','x+1/3! x^{3}',4);
%export to eps (change path and file name accordingly)
print('-depsc2',sprintf('C:\\Documents and Settings\\ajay\\Desktop\\BootCampFig_1203\\BC_2003\\matlab\\fig14a'));
